...
const Invest: FunctionComponent = () => {
  ...
  return (
    <div className="relative bg-black1-200 w-full h-[1862px] overflow-hidden text-left text-13xl text-gray-white font-montserrat md:flex">
      <img
      ...
      <div className="absolute top-[267px] left-[70px] flex flex-col items-start justify-center py-0 px-[0.0000152587890625px] text-35xl-1">
        <div className="w-[603px] h-[168px] flex flex-col items-start justify-start">
          <div className="relative leading-[90%] uppercase font-extrabold inline-block w-[571px]">
            <p className="m-0">{`Find investment `}</p>
      ...
      <div
        className="absolute top-[1103px] left-[590px] [&.animate]:animate-[3s_ease_1s_1_normal_forwards_fade-in] opacity-[0]"
        data-animate-on-scroll
      >
        <p className="m-0">
        ...
        <p className="m-0 text-base">
          If you want to learn more about the Internet Computer Protocol,, click
          here
        </p>
      </div>
      <Footers />
